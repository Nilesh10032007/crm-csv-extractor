      ...
      <div className="flex flex-col w-full px-4 lg:px-margin-desktop py-8 max-w-container-max mx-auto gap-gutter-desktop animate-in fade-in duration-700">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto mt-4 sm:mt-0">
            <div className="flex items-center gap-2 bg-surface-container-high px-4 py-2 rounded-full border border-outline-variant/30 flex-1">
              ...
              <input 
                ...
                className="bg-transparent border-none outline-none text-body-sm w-full sm:w-48 text-on-surface placeholder:text-on-surface-variant"
              />
            </div>
            <button className="px-4 py-2 bg-primary text-on-primary rounded-full font-label-md text-label-md flex items-center justify-center gap-2 hover:bg-primary/90 transition-all shadow-sm">
